...
class FakeWeatherForecastMapper() : Mapper.Weather {
     ...
     */
    override suspend fun localDailyForecastToData(localData: List<LocalDailyForecast>): List<DailyForecast> {
     ...
     */
    override suspend fun localHourlyForecastToData(localData: List<LocalHourlyForecast>): List<HourlyForecast> {
